...
def update_winner(id: str):
    winner_to_update = Winner.query.get_or_404(id)
...
@app.route('/winners/<id>/', methods=['DELETE'])
def delete_winner(id: str):
    winner_to_delete = Winner.query.get_or_404(id)
    app.logger.info(f"Deleting the winner with id={id}")
